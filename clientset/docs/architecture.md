...
clientset/transport/
  wire_mappings_generated.go                      # defaultMappings from +bridge:field markers

clientset/wrappers/
  wire_wrappers_generated.go                      # platform-scoped interfaces + WaitUntil from +bridge:wait markers
```
